            ...
            <div className="mt-16 flex items-center justify-between md:mt-24 lg:mt-32 xl:mt-40">
                <div className="flex max-w-[30rem] flex-col xl:max-w-2xl">
                    <h1 className="text-4xl xl:text-5xl">
                        Improve your
                        <span className="text-orange"> Vocabulary</span>, for
                        Free and in <span className="underline">No Time</span>
                    </h1>
                    <h2 className="mr-5 mt-8 text-rhythm sm:mr-0">
                        Wocaby is free and easy to use.By just a minute a
                        day,improve your vocabulary skills.
                    </h2>
                    <div className="ml-8 flex flex-col sm:flex-row sm:gap-x-10">
                        <button className="startButton mt-16 w-fit -translate-x-1/4 self-center border-4 border-darkOrange px-4 py-1 text-lg transition-shadow">
                            Start Now
                        </button>
                        <a
